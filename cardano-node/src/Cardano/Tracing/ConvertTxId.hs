...
import           Ouroboros.Consensus.Mock.Ledger.Block (SimpleBlock, TxId (..))
...
instance ConvertTxId (SimpleBlock c ext) where
  txIdToRawBytes = Crypto.hashToBytes . unSimpleGenTxId
